...
public class Hero : MonoBehaviour, IDamageAble, IUnit, IStunAble, IDebuffCarrier
{
    ...
    private void ApplyStatUpgradeBonus()
    {
        ...
        sc.AddModifier(StatType.ATK, new Modifier(ModifierType.Flat, bonus, 0f, StatLayer.Equip, StatUpgradeBonusSource));
        sc.AddModifier(StatType.DEF, new Modifier(ModifierType.Flat, bonus, 0f, StatLayer.Equip, StatUpgradeBonusSource));
    }
