...
public class FogLook : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 5f)] private float cloudWindSpeed = 1.5f;
    ...
    private static readonly int CloudWindId = Shader.PropertyToID("_CloudWindSpeed");
    ...
    private void ApplyFogLook()
    {
        ...
        Shader.SetGlobalFloat(CloudWindId, cloudWindSpeed);
    }
}
